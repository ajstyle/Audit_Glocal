(function() {
    ...
    angular.module('starter')
        .controller('InspectionCtrl', ['localStorageService', 'MyServices', '$scope', '$ionicPlatform', '$ionicLoading', '$ionicPopup', '$state', '$timeout', '$ionicHistory', '$cordovaCapture', InspectionCtrl])
        .controller('QuizCtrl', ['localStorageService', 'MyServices', '$scope', '$cordovaFile', '$cordovaFileTransfer', '$ionicPlatform', '$ionicModal', '$ionicLoading', '$ionicPopup', '$ionicHistory', '$state', '$timeout', '$http', '$cordovaGeolocation', '$location', '$cordovaCapture', '$cordovaProgress', QuizCtrl]);


    function InspectionCtrl(localStorageService, MyServices, $scope, $ionicPlatform, $ionicLoading, $ionicPopup, $state, $timeout, $ionicHistory, $cordovaCapture) {
    ...
    */
    ...
    function QuizCtrl(localStorageService, MyServices, $scope, $cordovaFile, $cordovaFileTransfer, $ionicPlatform, $ionicModal, $ionicLoading, $ionicPopup, $ionicHistory, $state, $timeout, $http, $cordovaGeolocation, $location, $cordovaCapture, $cordovaProgress) {
        var mediaFiles;
        ...
        $scope.imagesen = function(id) {
            ...
            $cordovaCapture.captureImage(options).then(function(mediaFiles) {
                var i, path, len, mediaName;
                    ...
                    $cordovaFileTransfer.upload(adminurl + "Imageupload", path, {})
                        .then(function(result) {
                          $ionicLoading.hide();
                            ...
                            console.log("$scope.images", $scope.imagese);
                            //$scope.imgdis(id) = true;
                            $cordovaFile.removeFile(fileURL, mediaName)
                                .then(function(result) {
        ...
        //       $cordovaFileTransfer.upload(adminurl + "mediaupload",$scope.path, {})
        //         .then(function(result) {
        //           console.log('vidsresult' ,  result);
        //           var data = JSON.parse(result.response);
                ...
                for (i = 0, len = mediaFiles.length; i < len; i += 1) {
                    ...
                    $cordovaFileTransfer.upload(adminurl + "mediaupload", path, {})
                        .then(function(result) {
                            ...
                            console.log("data", data);
                            $scope.videose[id] = data;
                            console.log("$scope.videose", $scope.videose);
                            //  $scope.viddis(id) = true;
                            $cordovaFile.removeFile(fileURL, $scope.path)
                                .then(function(result) {
        ...
        $scope.formSubmit = function() {
            ...
            var vide = JSON.stringify($scope.videose);
            ...
            console.log("video_JSON", JSON.stringify(video_Json));
            ...
            if ($scope.qtitle == "Checklist") {
                console.log(dar);
                $http.post(adminurl + 'checkResult', dar)
                    .success(function() {
                        successResult();
                    })
                    .error(function(data) {
                ...
                $http.post(adminurl + 'invResult', dar)
                    .success(function() {
                        successResult();
                    })
                    .error(function(data) {
                ...
                $http.post(adminurl + 'AssResult', darAss)
                    .success(function() {
                        successResult();
                    })
                    .error(function(data) {
                ...
                $http.post(adminurl + 'saveResult', dar)
                    .success(function() {
